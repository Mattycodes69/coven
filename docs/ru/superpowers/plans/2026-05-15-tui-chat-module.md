---
title: "План внедрения: выделение модуля чата TUI в coven-cli"
description: "План на русском по разделению chat.rs (1111 строк) в модуль tui/ внутри coven-cli за три коммита без изменения поведения и добавления новых зависимостей."
---
