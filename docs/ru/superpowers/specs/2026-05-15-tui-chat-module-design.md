---
title: "Проект: выделение модуля чата TUI в coven-cli"
description: "Спецификация на русском фазы 2 очистки TUI: chat.rs делится на состояние, представление, контроллер и жизненный цикл методом чистого перемещения кода."
---
